...
class ActionBarModel:ObservableObject {
	@Published var our_like:nostr.Event?
	@Published var our_boost:nostr.Event?
	...
	init(likes: Int, boosts: Int, zaps: Int, zap_total: Int64, our_like:nostr.Event?, our_boost:nostr.Event?, our_zap: Zap?) {
		self.likes = likes
		self.boosts = boosts
		self.zaps = zaps
