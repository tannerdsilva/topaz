...
final actor RelayConnection:ObservableObject {
	...
	public var reconnectionDelayTimeNanoseconds:UInt64 = 30_000_000_000 // (default: 10 seconds)
	...
	init(url:String, stateChannel:AsyncChannel<StateChangeEvent>, eventChannel:AsyncChannel<EventCapture>, subscriptionChannel:AsyncChannel<SubscriptionChangeEvent>) {
        self.url = url
