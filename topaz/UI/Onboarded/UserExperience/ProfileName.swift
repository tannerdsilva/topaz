...
struct EventProfileName: View {
	...
	init(pubkey: String, profile:nostr.Profile?, ue:UE, show_friend_confirmed: Bool, size: EventViewKind = .normal) {
		self.ue = ue
		self.pubkey = pubkey
		self.profile = profile
		self.prefix = ""
	...
	init(pubkey: String, profile:nostr.Profile?, prefix: String, ue:UE, show_friend_confirmed: Bool, size: EventViewKind = .normal) {
		self.ue = ue
		self.pubkey = pubkey
		self.profile = profile
		self.prefix = prefix
